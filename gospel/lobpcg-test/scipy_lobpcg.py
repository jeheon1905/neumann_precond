...
def lobpcg(
    ...
    _lambda = _lambda[ii]
    # print('========== Initial X ==========')
    # print(f'Initial X : {(blockVectorX**3).sum(0)}')
    # print(f'gramXAX : {gramXAX}')
    # print(f'XAX eig-vec : {eigBlockVector}')
    # print(f'XAX eig-val : {_lambda}')
    # print('-------------------------------')
    ...
    while iterationNumber < maxiter:
        ...
        if B is not None:
            ...
            # print('========== Initial Residual 2 ==========')
            # print((activeBlockVectorR**3).sum(0))
            activeBlockVectorR = activeBlockVectorR - np.matmul(
        ...
        if iterationNumber > 0:
            if B is not None:
                ...
                # print('========== activeBlockVectorP ==========')
                # print(np.linalg.norm(activeBlockVectorP,axis=0))
                # print(normal)
                # print('----------------------------------------')
        ...
        # print('========== gramXAR gramRAR ==========')
        # print((activeBlockVectorR**3).sum(0))
        # print((activeBlockVectorAR**3).sum(0))
        # print('-------------------------------------')
        ...
        if not restart:
            ...
            try:
                ...
                if verbosityLevel > 1:
                    print("************** gram XAX XAR XAP **************")
                    print(gramXAX)
                    print(gramXAR)
                    print(gramXAP)
                    print("************** gram RAR RAP PAP **************")
                    print(gramRAR)
                    print(gramRAP)
                    print(gramPAP)
                    print("************** gram XBX XBR XBP **************")
                    print(gramXBX)
                    print(gramXBR)
                    print(gramXBP)
                    print("************** gram RBR RBP PBP **************")
                    print(gramRBR)
                    print(gramRBP)
                    print(gramPBP)
