#!/bin/bash -l
#SBATCH --job-name=ab_B12_0.5
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_paper/alpha_ablation/jobs/B12_a0.5_%j.txt
...
echo "host: $(hostname)  commit: $(git rev-parse HEAD)  system: B12  alpha: 0.5"
for N in 4 5 6 7 8 9 10; do
  echo "########## B12 alpha=0.5 order=$N ##########"
  T0=$SECONDS
  ...
  echo "########## B12 alpha=0.5 order=$N DONE $((SECONDS-T0)) s ##########"
done
