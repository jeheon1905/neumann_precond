#!/bin/bash -l
#SBATCH --job-name=ab_B12_0.9
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_paper/alpha_ablation/jobs/B12_a0.9_%j.txt
...
echo "host: $(hostname)  commit: $(git rev-parse HEAD)  system: B12  alpha: 0.9"
for N in 4 5 6 7 8 9 10; do
  echo "########## B12 alpha=0.9 order=$N ##########"
  T0=$SECONDS
  ...
  echo "########## B12 alpha=0.9 order=$N DONE $((SECONDS-T0)) s ##########"
done
