#!/bin/bash -l
#SBATCH --job-name=bs_MAPbI3
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/band_MAPbI3_%j.txt
