#!/bin/bash -l
#SBATCH --job-name=conv_B12
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/conv_B12_%j.txt
#SBATCH --error=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/conv_B12_err_%j.txt
...
time $PY spectral_experiment.py \
    ...
    --krylov_dims 60 100 150 --arnoldi_seeds 0 \
    --outdir results_spectral_revision/global_spectrum/convergence \
    --tag B12_krylov_convergence
