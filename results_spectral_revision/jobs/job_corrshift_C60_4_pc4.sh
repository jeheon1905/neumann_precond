#!/bin/bash -l
#SBATCH --job-name=cs_C60_4_4
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/corrshift_C60_4_pc4_%j.txt
...
echo "host: $(hostname)  date: $(date)  probe_call=4  CORRECTED SHIFT (no --exact_shift)"
