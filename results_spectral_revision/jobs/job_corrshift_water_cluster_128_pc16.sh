#!/bin/bash -l
#SBATCH --job-name=cs_water_cluster_128_16
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/corrshift_water_cluster_128_pc16_%j.txt
...
time $PY spectral_experiment.py \
    ...
    --tag water_cluster_128_corrshift_pc16
