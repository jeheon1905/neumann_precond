#!/bin/bash -l
#SBATCH --job-name=df_water_cluster_128
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/defl_water_cluster_128_%j.txt
#SBATCH --error=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/defl_water_cluster_128_err_%j.txt
...
time $PY spectral_experiment.py \
    ...
    --tag water_cluster_128_deflated
