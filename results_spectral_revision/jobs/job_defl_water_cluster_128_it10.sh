#!/bin/bash -l
#SBATCH --job-name=d10_water_cluster_128
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/defl_water_cluster_128_it10_%j.txt
#SBATCH --error=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/defl_water_cluster_128_it10_err_%j.txt
...
echo "host: $(hostname)  date: $(date)  target i_iter=10 (probe_call=8)"
...
time $PY spectral_experiment.py \
    ...
    --verbosity 1 --seed 2 \
    --probe_call 8 --state_rules lowest middle homo slowest \
    ...
    --tag water_cluster_128_deflated_it10
