#!/bin/bash -l
#SBATCH --job-name=ex_water_cluster_128
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/exact_water_cluster_128_%j.txt
