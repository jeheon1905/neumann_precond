#!/bin/bash -l
#SBATCH --job-name=fl2_B12
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/fill_B12_g2_%j.txt
...
time $PY spectral_experiment.py \
    ...
    --state_rules homo 100 125 150 175 \
