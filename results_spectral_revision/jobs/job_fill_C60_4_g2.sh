#!/bin/bash -l
#SBATCH --job-name=fl2_C60_4
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/fill_C60_4_g2_%j.txt
...
time $PY spectral_experiment.py \
    ...
    --state_rules homo 192 240 288 336 \
