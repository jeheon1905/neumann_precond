#!/bin/bash -l
#SBATCH --job-name=fl3_C60_4
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/fill_C60_4_g3_%j.txt
