#!/bin/bash -l
#SBATCH --job-name=fl2_MAPbI3
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/fill_MAPbI3_g2_%j.txt
...
time $PY spectral_experiment.py \
    ...
    --state_rules homo 256 320 384 448 \
