#!/bin/bash -l
#SBATCH --job-name=fl2_water_cluster_128
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/fill_water_cluster_128_g2_%j.txt
