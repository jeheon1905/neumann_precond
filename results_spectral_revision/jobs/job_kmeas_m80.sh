#!/bin/bash -l
#SBATCH --job-name=km80
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/kmeas_m80_%j.txt
...
echo "host: $(hostname)  commit: $(git rev-parse HEAD)  verify_dim=80"
...
time $PY spectral_experiment.py \
    ...
    --verify_order_form 1 2 3 5 8 --verify_dim 80 \
    --outdir results_spectral_revision/kappa_measured --tag B12_kappa_m80
