#!/bin/bash -l
#SBATCH --job-name=rc_MAPbI3
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/rec_MAPbI3_%j.txt
...
time $PY spectral_experiment.py \
    ...
    --outdir results_spectral_revision/recursion --tag MAPbI3_recursion
