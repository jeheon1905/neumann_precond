#!/bin/bash -l
#SBATCH --job-name=rhomid_B12
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/rho_mid_B12_%j.txt
...
time $PY spectral_experiment.py \
    --filepath data/systems/B12.sdf --supercell 1 1 1 --pbc 0 0 0 --spacing 0.2 \
