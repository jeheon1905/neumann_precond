#!/bin/bash -l
#SBATCH --job-name=rhomid_MAPbI3
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/rho_mid_MAPbI3_%j.txt
...
time $PY spectral_experiment.py \
    --filepath data/systems/MAPbI3.cif --supercell 2 2 2 --pbc 1 1 1 --spacing 0.2 \
