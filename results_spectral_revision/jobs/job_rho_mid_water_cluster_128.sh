#!/bin/bash -l
#SBATCH --job-name=rhomid_water_cluster_128
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/rho_mid_water_cluster_128_%j.txt
...
time $PY spectral_experiment.py \
    --filepath data/systems/water_cluster_128.xyz --supercell 1 1 1 --pbc 0 0 0 --spacing 0.2 \
    ...
    --tag water_cluster_128_rho_middle
