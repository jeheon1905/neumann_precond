#!/bin/bash -l
#SBATCH --job-name=sd_B12_4
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/shiftdyn_B12_pc4_%j.txt
