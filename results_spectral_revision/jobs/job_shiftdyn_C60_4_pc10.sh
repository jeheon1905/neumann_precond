#!/bin/bash -l
#SBATCH --job-name=sd_C60_4_10
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/shiftdyn_C60_4_pc10_%j.txt
...
echo "host: $(hostname)  date: $(date)  probe_call=10"
echo "commit: $(git rev-parse HEAD)  branch: $(git branch --show-current)"
time $PY spectral_experiment.py \
    --filepath data/systems/C60_4.xyz --spacing 0.2 --supercell 1 1 1 --pbc 0 0 0 \
