#!/bin/bash -l
#SBATCH --job-name=sd_water_cluster_128_10
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/shiftdyn_water_cluster_128_pc10_%j.txt
...
time $PY spectral_experiment.py \
    ...
    --tag water_cluster_128_shiftdyn_pc10
