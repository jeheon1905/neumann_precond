#!/bin/bash -l
#SBATCH --job-name=spec_water_cluster_128
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/spec_water_cluster_128_%j.txt
#SBATCH --error=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/spec_water_cluster_128_err_%j.txt
...
time $PY spectral_experiment.py \
    ...
    --krylov_dims 20 40 60 --arnoldi_seeds 0 1 \
    --outdir results_spectral_revision/global_spectrum/raw \
    --tag water_cluster_128_global
