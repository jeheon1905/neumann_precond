#!/bin/bash -l
#SBATCH --job-name=sv_B12
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/survey_B12_%j.txt
...
# Survey of the WHOLE occupied manifold, every 10-th band, deflated, m=30.
...
time $PY spectral_experiment.py \
    ...
    --probe_call 13 --state_rules stride:10 --skip_global --krylov_dims 30 \
    --deflated --deflated_dims 30 --cg_maxiter 0 --eta_max_order 0 \
    --outdir results_spectral_revision/manifold_survey --tag B12_survey
