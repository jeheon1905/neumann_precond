#!/bin/bash -l
#SBATCH --job-name=sv_C60_4
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/survey_C60_4_%j.txt
...
time $PY spectral_experiment.py \
    ...
    --outdir results_spectral_revision/manifold_survey --tag C60_4_survey
