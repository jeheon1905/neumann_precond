#!/bin/bash -l
#SBATCH --job-name=svd_C60_4
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/svd_C60_4_%j.txt
...
time $PY spectral_experiment.py \
    ...
    --verbosity 1 --seed 2 \
    --probe_call 13 --state_rules homo lowest \
    --skip_global --krylov_dims 40 \
    --deflated --deflated_dims 80 --cg_maxiter 0 --eta_max_order 0 \
    --svd_bounds 0 2 5 8 --svd_dim 80 --svd_arnoldi_dim 80 \
