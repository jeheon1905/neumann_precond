#!/bin/bash -l
#SBATCH --job-name=svd_water_cluster_128
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/svd_water_cluster_128_%j.txt
