#!/bin/bash -l
#SBATCH --job-name=verify_B12
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/verify_B12_%j.txt
...
time $PY spectral_experiment.py \
    ...
    --probe_call 13 --state_rules homo lowest --skip_global --krylov_dims 30 \
    --deflated --deflated_dims 30 --cg_maxiter 0 --eta_max_order 0 \
    --verify_order_form 2 5 8 --verify_dim 30 \
    --outdir results_spectral_revision/order_form_verification --tag B12_order_form
