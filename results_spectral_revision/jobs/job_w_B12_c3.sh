#!/bin/bash -l
#SBATCH --job-name=w_B123
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/w_B12_c3_%j.txt
...
time $PY spectral_experiment.py \
    ...
    --weights 16 \
    --outdir results_spectral_revision/weights --tag B12_weights_c3
