#!/bin/bash -l
#SBATCH --job-name=w_MAPbI33
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/w_MAPbI3_c3_%j.txt
...
time $PY spectral_experiment.py \
    ...
    --weights 16 \
    --outdir results_spectral_revision/weights --tag MAPbI3_weights_c3
