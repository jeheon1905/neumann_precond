#!/bin/bash -l
#SBATCH --job-name=w_water_cluster_1283
#SBATCH --output=/home/jhwoo1905/Projects/neumann_precond/results_spectral_revision/jobs/w_water_cluster_128_c3_%j.txt
...
time $PY spectral_experiment.py \
    ...
    --probe_call 3 --state_rules lowest middle homo --skip_global --krylov_dims 30 \
    --deflated --deflated_dims 30 --cg_maxiter 0 --eta_max_order 0 \
    --weights 16 \
    --outdir results_spectral_revision/weights --tag water_cluster_128_weights_c3
